...
class PrivacyPolicyScreen extends StatelessWidget {
  ...
  Future<void> _openEmail() async {
    final uri = Uri(
      scheme: 'mailto',
      path: 'IotAppSupport@markenworld.com',
      query: 'subject=Marken IoT Support',
    );
...
Application refers to Marken IoT, the software program provided by the Company.

Company (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Tepid Industries PVT LTD , HYDERABAD, india.
